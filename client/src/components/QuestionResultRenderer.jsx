...
/**
 * Render sub-questions (read-only, supports nested sub-questions)
 */
function SubQuestionResultRenderer({ subQuestion, index, parentQuestionId, parentAnswer, answers, depth = 0 }) {
